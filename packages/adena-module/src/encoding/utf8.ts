// Global symbols in both browsers and Node.js since v11 so no need to declare them here. See https://nodejs.org/docs/latest-v12.x/api/util.html#util_class_util_textencoder
