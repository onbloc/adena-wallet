...
import { strToSignedTx } from '../../utils/index.js';
...
describe('create address keyring', () => {
  it('create address keyring from address', async () => {
    ...
    expect([...addressKeyring.addressBytes]).toStrictEqual([146, 15, 181, 241, 124, 45, 175, 116, 187, 21, 153, 183, 203, 224, 41, 90, 94, 30, 201, 183]);
      ...
      signatures: [
        {
          pubKey: {
            ...
            value: new Uint8Array([3, 225, 97, 54, 219, 23, 30, 50, 223, 72, 153, 53, 148, 31, 5, 110, 34, 248, 152, 99, 227, 115, 157, 10, 183, 205, 73, 236, 66, 131, 156, 157, 178])
          },
          signature: new Uint8Array([232, 153, 55, 130, 206, 122, 227, 1, 147, 186, 211, 93, 56, 60, 237, 53, 73, 96, 243, 207, 214, 30, 99, 15, 152, 145, 145, 100, 112, 238, 87, 77, 12, 115, 211, 57, 128, 101, 129, 100, 49, 41, 27, 43, 11, 178, 172, 227, 48, 60, 102, 177, 59, 181, 60, 187, 83, 97, 244, 227, 208, 170, 97, 25])
        }
      ],
      memo: ''
    };
