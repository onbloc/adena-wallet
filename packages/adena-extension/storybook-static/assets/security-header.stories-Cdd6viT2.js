...
`,y=i(l)`
  width: 24px;
`,b=({currentStep:e,stepLength:t,visibleBackButton:n,onClickGoBack:i})=>{let a=r();return(0,g.jsxs)(_,{children:[n?(0,g.jsx)(u,{onClick:i,style:{padding:4,backgroundColor:a.webInput._100,borderRadius:16},children:(0,g.jsx)(d,{src:m,size:24})}):(0,g.jsx)(y,{}),t>0&&(0,g.jsx)(c,{style:{columnGap:8},children:h.default.times(t,t=>(0,g.jsx)(v,{selected:t===e},t))}),(0,g.jsx)(y,{})]})},b.__docgenInfo={description:``,methods:[],displayName:`WebSecurityHeader`,props:{currentStep:{required:!1,tsType:{name:`number`},description:``},stepLength:{required:!0,tsType:{name:`number`},description:``},visibleBackButton:{required:!0,tsType:{name:`boolean`},description:``},onClickGoBack:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})),S,C,w,T;e((()=>{x(),{action:S}=__STORYBOOK_MODULE_ACTIONS__,C={title:`components/pages/WebSecurityHeader`,component:b},w={args:{currentStep:0,stepLength:2,visibleBackButton:!0,onClickGoBack:S(`click back`)}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    currentStep: 0,
    stepLength: 2,
