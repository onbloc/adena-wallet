...
`})),_,v,y,b=t((()=>{p(),_=e(c()),g(),v=u(),y=({content:e,iconColor:t})=>{let[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)({}),[o,s]=(0,_.useState)({left:`50%`,transform:`translateX(-50%)`}),c=(0,_.useRef)(null),l=(0,_.useRef)(null);(0,_.useEffect)(()=>{n&&c.current&&l.current&&u()},[n]);let u=()=>{if(!c.current||!l.current)return;let e=c.current.getBoundingClientRect(),t=window.innerWidth,n=e.left+e.width/2,r=e.top,i=n-300/2,o=(n-i)/300*100;i<8?(i=8,o=(n-i)/300*100):i+300>t-8&&(i=t-300-8,o=(n-i)/300*100),o=Math.max(8,Math.min(92,o)),a({left:i,top:r-14,transform:`translateY(-100%)`}),s({left:`${o}%`,transform:`translateX(-50%)`})};return(0,v.jsxs)(m,{ref:c,onMouseOver:()=>r(!0),onMouseLeave:()=>r(!1),children:[(0,v.jsx)(f,{color:t}),n&&(0,v.jsx)(h,{ref:l,$position:i,$arrowPosition:o,children:e})]})},y.__docgenInfo={description:``,methods:[],displayName:`InfoTooltip`,props:{content:{required:!0,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:``},iconColor:{required:!1,tsType:{name:`string`},description:``}}}}));export{b as n,y as t};