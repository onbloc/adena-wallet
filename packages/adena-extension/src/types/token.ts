...
export interface NativeTokenModel extends TokenModel { denom: string }

export interface GRC20TokenModel extends TokenModel { pkgPath: string }

export interface IBCNativeTokenModel extends TokenModel { denom: string }
