...
import { StorageMigration013 } from './storage-migration-v013';
...
describe('serialized wallet migration V013', () => {
  ...
  it('up success', async () => {
    ...
    expect(result.data.CURRENT_CHAIN_ID).toEqual('test9');
    expect(result.data.CURRENT_NETWORK_ID).toEqual('test9');
  });
