...
interface NativeTokenInfo extends TokenInfo { denom: string }

interface GRC20TokenInfo extends TokenInfo { pkg_path: string }

interface IBCNativeTokenInfo extends TokenInfo { denom: string }
